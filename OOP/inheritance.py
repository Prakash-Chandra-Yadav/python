...
ecar = ElectricCar('nneww','byd',2027)
ecar.get_descriptive_name()
ecar.fill_gas_tank()
ecar.read_odometer()
ecar.update_odometer(200)
ecar.battery.show_battery_capacity()
ecar.battery.get_range()
ecar.battery.update_battery(65)
ecar.battery.get_range()
ecar.battery.update_battery(65)
ecar.battery.update_battery(400)
